...
export const Footer = () => (
  <footer className="mt-40 border-t border-transparent-white py-[5.6rem] text-sm">
    <div className="flex flex-col mx-auto max-w-[1200px] px-8 justify-between lg:flex-row">
      <div>
